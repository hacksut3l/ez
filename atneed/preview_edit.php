...
<div class="web-layout">
	...
	<div class="container">	
      ...
      <div class="left-content" style="width:949px;">
			<a href="../client_dashboard.php"><input type="button" class="login_button" value="Back"  style="margin-top:5px; width:100px;"/></a>
        	<h2 class="heading" style="width:949px; margin-bottom:10px;"><center>Edit your Funeral Plan</center></h2>
