	...
	<div class="web-960" style="width:693px;">	
      ...
      <div class="content-wrap" style="width:693px;">
      	<div class="left-content" style="text-align:left;">
        	<h2 class="heading">AFTER THE FUNERAL</h2>
            ...
            <!--start mpd-form-->
            <form name="person_making_form" action="save-funeral-edit.php" method="POST">
            <div class="mpd-form">
                    <fieldset class="fieldset">
                     ...
                     <div class="help-f"><a id="example2" href="#inline3"><img src="<?php echo base_url;?>images/helpbutton.png" alt="" /></a></div>
                       <div style="display: none;">
                      <div id="inline3" style="width:400px;height:auto;overflow:hidden; padding:10px 5px 10px 05px; text-align:justify;">
                            <p>Some people prefer to keep the ashes at home in a casket or urn designed for that purpose. In some cases this is so that when a spouse or partner dies, the remains of both can be scattered or buried together. Others place a small amount in a piece of jewellery, for example a specially designed locket.</p>
                      </div>
                    </div>
                   <fieldset class="fieldset">
                   ...
                   <div class="f-row-1">
                     ...
                     <span class="ch-field">Funeral Director </span>                            </p>
                      ...
                      <p class="tx-area" id="">
                        ...
                        <div class="f-row-1">
                        	<h3>Do you require an urn or casket for the cremated remains?  <a id="example2" href="#inline2"><img src="<?php echo base_url;?>images/helpbutton.png" alt="" style="float:right;" /></a></h3>
                             <div style="display: none;">
		<div id="inline2" style="width:400px;height:auto;overflow:hidden; padding:10px 5px 10px 05px; text-align:justify;">
			<p>Choosing a cremation urn is a very personal choice which takes time. Finding and deciding upon an urn which best suits both the personality of the deceased and the 	tastes of the family is an important decision. </p>
		</div>
				</div>
                             <p class="tx-area">
               ...
               <div class="help-f"><a id="example2" href="#inline6"><img src="<?php echo base_url;?>images/helpbutton.png" alt="" /></a></div>
                       <div style="display: none;">
              ...
              <fieldset class="fieldset">
               ...
               <div class="help-f"><a id="example2" href="#inline8"><img src="<?php echo base_url;?>images/helpbutton.png" alt="" /></a></div>
                       <div style="display: none;">
                      <div id="inline8" style="width:400px;height:auto;overflow:hidden; padding:10px 5px 10px 05px; text-align:justify;">
