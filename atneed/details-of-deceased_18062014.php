<?php
	...
	$sql = "SELECT * FROM  deceased WHERE person_making_id = '".$_SESSION['person_id']."' ";
...
<script src="<?php echo base_url;?>js/deceased-vali.js" type="text/javascript"></script>
...
<div class="web-layout">
	<div class="web-960">	
      ...
      <div class="form-navigation"><img src="<?php echo base_url;?>images/nav02.png" alt="" /></div>
      <!--end form-navigation-->
      <!--start content-wrap-->
      <div class="content-wrap">
      	<div class="left-content">
        	<h2 class="heading">Details Of Deceased</h2>
            <div class="help-f"><a id="example2" href="#inline1"></a></div>
            <!--start mpd-form-->
		...
		<div id="inline4" style="width:400px;height:auto;overflow:hidden; padding:10px 5px 10px 05px; text-align:justify;font-size:12px; line-height:20px;">
            ...
            <div class="f-row-2">
                 <p style="float:right;">
                 	<input type="image" id="dsubmit" src="<?php echo base_url;?>images/submit_next.png"/> 
                 </p>
                 <p style="float:left;">
                 	<a href="person-making-arrangements.php"><img src="<?php echo base_url;?>images/submit_prev.png" /></a>
                 </p>         
           </div>
            </form>
            <!--end mpd-form-->
