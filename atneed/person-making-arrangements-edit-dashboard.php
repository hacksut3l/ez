	...
	<div class="web-960" style="width:693px;">	
      ...
      <div class="content-wrap" style="width:693px;">
      	<div class="left-content" style="text-align:left;">
        	<h2 class="heading">PERSON MAKING ARRANGEMENTS <?php echo $_SESSION['client']; ?></h2>
            <div class="help-f"></div>
            <!--start mpd-form-->
            <form name="person_making_form" action="save-person-making-edit-dashboard.php" method="POST">
            <div class="mpd-form">
