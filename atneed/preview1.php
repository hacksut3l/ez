...
<div class="web-layout">
	...
	<div class="web-960">	
      ...
      <div class="left-content" style="width:949px;">
        	...
        	<h2 class="heading" style="width:949px; margin-bottom:10px;">Get ready to check your Funeral Plan</h2>
		...
		<sp class="gree_pas" style="font-size:15px !important;"> This is just a preview. Following  payment you will receive a professional pdf of your personal Funeral Plan. After you have received your  plan, you can <strong>POST</strong> it on our website for <strong>FREE</strong> and INVITE up to 10 Funeral Directors in your area to quote on your funeral. We will help you compare prices and identify which Funeral Directors can give you the best funeral at the best price... saving your time and money.</sp>]</p>

        <center><a href="javascript:void(0);" ><img src="<?php echo base_url;?>images/show-preview-btn.png" alt="" id="preview-btn" title="" style="margin-bottom:10px;" /></a></center>
        ...
        <!--section one start here-->	
      	...
      	<div class="left-content" style="width:949px;">
        	...
        	<h2 class="heading" style="width: 949px; background:#dcdcdc; float: left; padding-bottom: 8px; " id="div1">Person Making Arrangements <!--<a href="javascript:void(0)" class="previewdiv" current_id="1">[+]</a>--> </h2>

            

            <div class="help-f" style="width: 150px; background:#dcdcdc; float: right; padding-top:0px; margin-top:-31px;"><a href="#" class="big-link" data-reveal-id="myModal">

                    <img src="<?php echo base_url;?>images/edit.png" alt="" title="Edit" />
...
<p style="float: left; width: 100%; margin-top: 8px;"><label><span style="font-weight:bold; font-size:12px;">  Address1 :</span> <?php echo $person['address1'];?></label></p>
        ...
        <!--section two start here-->	
      	...
      	<div class="left-content" style="margin-top:20px; width:949px;">
        	...
        	<h2 class="heading" style="width: 949px; background:#dcdcdc; float: left; padding-bottom: 8px;" id="div2">Details of Deceased<!--<a href="javascript:void(0)" class="previewdiv" current_id="2">[+]</a>--> </h2><div class="help-f" style="width: 150px; background:#dcdcdc; float: right; padding-top:0px;  margin-top:-31px;"><a href="#" class="big-link" data-reveal-id="myModal1">
 ...
 <p style="float: left; width: 100%; margin-top: 8px;"><label><span style="font-weight:bold; font-size:12px;">
                    ...
                    <!--<div id="is_prepaid_div" style="float:left;">
                      ...
                      <div class="f-row-1">
                        ...
                        <p class="fl-name">
                    <label><span style="font-weight:bold;" class="blue1"><?php echo $person['business_name'];?></span></label><label><p style="width:680px; float:left; line-height:22px;"><span style="font-size:12px; text-align:justify;">Address goes here Address goes here Address goes hereAddress goes here Address goes here Address goes hereAddress goes here Address, Mumbai, Maharashtra, 4220045</span></p></label>
  <br />                        <p style="float: left; width: 100%; margin-top: 8px;"> <label><span style="font-weight:bold;">Phone :</span><?php echo $deceased['telephone'];?></label></p>                 <p style="float: left; width: 100%; margin-top: 8px;"><label><span style="font-weight:bold;">Mobile :</span><?php echo $deceased['mobile'];?></label>
</p> 
...
<!--end mpd-form-->
        ...
        <!--section three start here-->	
      	...
      	<div class="left-content" style="margin-top:20px; width:949px;">
        	...
        	<h2 class="heading" style="width: 949px; background:#dcdcdc; float: left; padding-bottom: 8px;"id="div3">Details Of Committal <!--<a href="javascript:void(0)" class="previewdiv" current_id="3">[+]</a>--></h2> <div class="help-f" style="width: 150px; background:#dcdcdc; float: right; padding-top:0px; margin-top:-31px;"><a href="#" class="big-link" data-reveal-id="myModal2">
        ...
        <!--section four start here-->	
      	...
      	<div class="left-content" style="margin-top:20px; width:949px;">
        	...
        	<h2 class="heading" style="width: 949px; background:#dcdcdc; float: left; padding-bottom: 8px;"id="div4">Details of Funeral Service <!--<a href="javascript:void(0)" class="previewdiv" current_id="4">[+]</a>--></h2> <div class="help-f" style="width: 150px; background:#dcdcdc; float: right; padding-top:0px; margin-top:-31px;"><a href="#" class="big-link" data-reveal-id="myModal3">
...
-->
        ...
        <!--section five start here-->	
      	...
      	<div class="left-content" style="margin-top:20px; width:949px;">
        	...
        	<h2 class="heading" style="width: 949px; background:#dcdcdc; float: left; padding-bottom:8px;"id="div5">After the Funeral <!--<a href="javascript:void(0)" class="previewdiv" current_id="5">[+]</a>--></h2> <div class="help-f" style="width: 150px; background:#dcdcdc; float: right; padding-top:0px; margin-top:-31px;"><a href="#" class="big-link" data-reveal-id="myModal4">
...
-->
            ...
            <div class="f-row-2">
                 ...
                 <p style="float:right; font-size:12px;">
                 	...
                 	<strong><span style=" font-size:20px; line-height:26px;">Is your draft Funeral Plan OK?</span></strong><br />
                   ...
                   <span id="next-span"> 
                    ...
                    <a href="after-the-funeral.php" data-reveal-id="myModal6">

                    <img src="<?php echo base_url;?>images/submit_next.png" style="float: left; width: 28%; margin-top: 5px;"/></a>
                   ...
                   <span id="back-span"> 
                   	...
                   	<span class="blue1" style="line-height:24px; text-transform:none;  font-size:16px;">Okay, so you're still unsure, then re-edit your form using edit for each section above.</span><br />

                    <a href="after-the-funeral.php" data-reveal-id="myModal6"></a>
                 ...
                 <div id="myModal6" class="reveal-modal" style="height:300px; overflow:hidden; ">

                        <?php include("preview-new-nextpop.php") ?>
