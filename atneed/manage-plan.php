      ...
      <!--start content-wrap-->
        ...
        <!--section one start here-->	
      	...
      	<div class="left-content" style="width:949px;">
        	...
        	<h2 class="heading" style="width: 823px; background:#dcdcdc; float: left; padding-bottom: 8px; " id="div1">Person Making Arrangements <!--<a href="javascript:void(0)" class="previewdiv" current_id="1">[+]</a>--> </h2>

            

            <div class="help-f" style="width: 150px; background:#dcdcdc; float: right; padding-top:0px; margin-top:-30px; margin-right: 120px;"><a href="#" class="big-link" data-reveal-id="myModal">

                   <input type="button" class="login_button" value="preview" style="width:80px; height:25px; padding:0px; border-radius:6px; font-size:12px;"/>

                    </a>

                    <div id="myModal" class="reveal-modal" style="top: 1px !important; left: 27% !important; margin-left: -250px !important;">

                        <?php include("person-making-arrangements-edit-dashboard.php") ?>
...
<p style="float: left; width: 100%; margin-top: 8px;"><label><span style="font-weight:bold; font-size:12px;">  Address1 :</span> <?php echo $person['address1'];?></label></p>
        ...
        <!--section two start here-->	
      	...
      	<div class="left-content" style="margin-top:20px; width:949px;">
        	...
        	<h2 class="heading" style="width: 823px; background:#dcdcdc; float: left; padding-bottom: 8px;" id="div2">Details of Deceased<!--<a href="javascript:void(0)" class="previewdiv" current_id="2">[+]</a>--> </h2>
				<div class="help-f" style="width: 150px; background:#dcdcdc; float: right; padding-top:0px;  margin-top:-30px; margin-right: 120px;"><a href="#" class="big-link" data-reveal-id="myModal1">

                   <input type="button" class="login_button" value="preview" style="width:80px; height:25px; padding:0px; border-radius:6px; font-size:12px;"/>

                    </a>

                    <div id="myModal1" class="reveal-modal" style="top: 1px !important; left: 27% !important; margin-left: -250px !important;">>
...
<!--end mpd-form-->
        ...
        <!--section three start here-->	
      	...
      	<div class="left-content" style="margin-top:20px; width:949px;">
        	...
        	<h2 class="heading" style="width: 823px; background:#dcdcdc; float: left; padding-bottom: 8px;"id="div3">Details Of Committal <!--<a href="javascript:void(0)" class="previewdiv" current_id="3">[+]</a>--></h2>
			<div class="help-f" style="width: 150px; background:#dcdcdc; float: right; padding-top:0px; margin-top:-30px; margin-right: 120px; "><a href="#" class="big-link" data-reveal-id="myModal2">

                    <input type="button" class="login_button" value="preview" style="width:80px; height:25px; padding:0px; border-radius:6px; font-size:12px;"/>

                    </a>

                    <div id="myModal2" class="reveal-modal" style="top: 1px !important; left: 27% !important; margin-left: -250px !important;">>
        ...
        <!--section four start here-->	
      	...
      	<div class="left-content" style="margin-top:20px; width:949px;">
        	...
        	<h2 class="heading" style="width: 823px; background:#dcdcdc; float: left; padding-bottom: 8px;"id="div4">Details of Funeral Service <!--<a href="javascript:void(0)" class="previewdiv" current_id="4">[+]</a>--></h2> 
			<div class="help-f" style="width: 150px; background:#dcdcdc; float: right; padding-top:0px; margin-top:-30px; margin-right: 120px;"><a href="#" class="big-link" data-reveal-id="myModal3">

                    <input type="button" class="login_button" value="preview" style="width:80px; height:25px; padding:0px; border-radius:6px; font-size:12px;"/>

                    </a>

                    <div id="myModal3" class="reveal-modal" style="top: 1px !important; left: 27% !important; margin-left: -250px !important;">>
        ...
        <!--section five start here-->	
      	...
      	<div class="left-content" style="margin-top:20px; width:949px;">
        	...
        	<h2 class="heading" style="width: 823px; background:#dcdcdc; float: left; padding-bottom:8px;"id="div5">After the Funeral <!--<a href="javascript:void(0)" class="previewdiv" current_id="5">[+]</a>--></h2> 
			 <div class="help-f" style="width: 150px; background:#dcdcdc; float: right; padding-top:0px; margin-top:-30px; margin-right: 120px;"><a href="#" class="big-link" data-reveal-id="myModal4">

                    <input type="button" class="login_button" value="preview" style="width:80px; height:25px; padding:0px; border-radius:6px; font-size:12px;"/>

                    </a>

                    <div id="myModal4" class="reveal-modal" style="top: 1px !important; left: 27% !important; margin-left: -250px !important;">>
