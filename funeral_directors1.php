...
<script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(page){
                    ...
                    ({
                        type: "POST",
                        url: "funeral_director_search1.php",
...
<div class="gridContainer clearfix">
  <div id="LayoutDiv1">
     ...
     <div style="background:#15B5C6;  width: 100%; float:left">
                ...
                <div class="in-content">
                       ...
                       <div id="map" style="width: 100%; height: 243px;margin-bottom: 30px;float:left;"></div>
                   <!--<div class="google">
                     ...
                     <div id="loading"></div>
                      <div style="width:100%; float:left;" id="container1">  
                     <?php
