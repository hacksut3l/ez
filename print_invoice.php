<?php
	...
	session_start();
		...
		$sel_paln="select * from clients where id='".$_SESSION['client']."'";
		...
		$sel_purchase="select * from client_purchase_info where client_id='".$_SESSION['client']."' and receipt_no='".$_GET['id']."'";
...
<div style="border: 1px solid #CCCCCC;float: left; margin:50px 250px; padding-bottom: 20px; width: 800px;">
...
<?php  echo $row_of_plan['first_name']; ?><br/>
<?php echo $row_of_plan['last_name']; ?><br/>
<?php echo $row_of_plan['address']; ?><br/>
<?php echo $row_of_city['city_name'].$row_of_plan['zip_code']; ?><br/>
...
border-left: 1px solid #f1f1f1;"><?php if($row_of_purchase['pdf_type']='At Need Plan'){ echo $plan='Direct'; }else {echo $plan='Advance';} ?>Membership Package<br/></td>
...
<div style="margin-left:500px;"><input type="button" onclick="window.print()" value="Print" class="login_button"> &nbsp;&nbsp;&nbsp;<a href="client_dashboard.php"><input type="button" value="Cancel" class="login_button"></a></div>
