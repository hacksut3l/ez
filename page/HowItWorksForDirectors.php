...
<div class="container_full">
  <div class="slider_static_image_directors">
    <div class="container">
      <div class="static_full_img">
        <div align="right" style="margin-top:110px;margin-right: -20%;" class="banner_all_cover"> <font style="color:#00a3b4; font-size:42px; font-family: 'Helvetica IE', Arial; line-height:1.0;" class="banner_title1"><br />
          Helping you help more families</font><br /><br/>
			  <font style="color:#00a3b4; font-size:30px; fontfont-family: 'Helvetica Medium 65', Arial;" class="banner_title2">Connect with more families and<br/> grow your business online.</font><br />
          </div>
      </div>
    </div>
  </div>
...
<div class="content_fullwidth" style="background:#00a3b4; color:#FFFFFF;">
  <center>
    <font style="font-size:28px; font-family:Arial, Helvetica, sans-serif;">HERE'S HOW IT WORKS</font>
  </center>
  <br />
</div>
<div class="content_fullwidth" style="background:url(../images/sliderarrow.png) center top no-repeat; margin-top:-15px;"> </div>
<div class="container" style="background:#FFFFFF">
  <!--<div class="mar_top5"></div>-->
  <div class="content_fullwidth">
    <center>
      <p style="font-family:'Helvetica Medium 65', Arial; font-size:20px;">eziFunerals is designed to help you help more families.</p>
    </center>
    <center>
      <p style="font-family:'Helvetica Medium 65', Arial; font-size:20px;">Specifically for funeral directors, we've included just the right mix of features and ease-of-use functionality.</p>
    </center>
    </br>
    </br>
  </div>
...
<div class="content_fullwidth" style="background:#ededed !important;">
<div class="container" style="background:#ededed !important; width:900px;">
...
<p align="center" style="color:#008c9b;line-height:3;"><br />
  t</p>
...
<div class="pricing-tables-two director_box2" style="background:#00a3b4;margin-left:3px;">
  ...
  <div class="price" style="background:#00a3b4"><br />
    $49 <i>per lead</i></div>
  <div class="title box3_title3 director_title" style="background:#00a3b4; line-height:5px; height:96px;">$79 monthly fee</div>
  <br/>
  <br/>
  <br/>
...
<div class="pricing-tables-two director_box3" style="background:#008c9b !important; height:185px; margin-left:3px;">
  <div class="title" style="background:#ef8b2f">PREMIUM</div>
  <p align="center" style="color:#008c9b;">s</p>
  <div class="price" style="background:#008c9b;"><br />
    <br/>
    $29 <i>per lead</i></div>
	<div class="title box3_title3 director_title" style="background:#008c9b; line-height:0px; height:10px;">$99* monthly fee</div>
...
<div class="colored_bg question_bg" style="background:url(../images/blackbanner.png); height:525px;">
  <div class="container">
    ...
    <div align="center"> <font style="color:#FFFFFF; font-family: 'Helvetica Medium 65', Arial; font-size:22px;">FAQ'S</font><br />
      <br />
      <br />
    </div>
    <div class="one_full">
	  ...
	  <div align="center" style="position:absolute; margin-top:27%; margin-left:27%">
	  	<a href="https://ezifunerals.zendesk.com/hc/en-us" target="_blank" class="readmore_but_03 director_faq_btn">View More FAQs</a>
	 </div>
    ...
    <div class="Lmenu7" id="faqs_anso" style="display:none"><br />
      ...
      <br />
      <br />
      eziFunerals target market includes Families of Baby boomers;Aged care service providers;Employers and Life Insurance companies and businesses and services who want to increase their market share and improve their market visibility. </div>
...
<!----------------------------------------------------------------------Forgot Password popup------------------------------------------------------------------------------------->					
					...
					<a href="#x" class="overlay" id="span2"></a>
					<div class="popup">
							<h1 class="login_head">Access Denied</h1>	
				<div class="row">
						...
						<div class="col-md-5">
							 "Oops...", "You Are Not director First You Have To Sign Out Then Ofter sign Up <br/> As a Client after Registration You can access This fetures!"
						</div>
				...
				<div class="row">
					...
					<div class="col-md-5">
							<span style="float:left;"><br>
											<a href="#close"><input type="button" name="submit" value="Ok" class="login_button" /></a>
							</span>
...
<div class="grey_bg" align="" style="background:#f5f5f5; ">
	<div class="container container_find" >
        <center><div class="one_full director_info_all">
			...
			<p style="font-family:Arial, Helvetica, sans-serif; font-size:17px;">Let us know your email address and we will send you a copy of our guide for funeral directors.</p><br />
			...
			<input type="hidden" name="pagename" value="<?php echo basename($_SERVER['SCRIPT_NAME']).'?type=director';?>"/>
