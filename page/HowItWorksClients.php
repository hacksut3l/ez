  ...
  <div class="slider_static_image_clients">
    <div class="container">
      <div class="static_full_img">
        <div align="right" style="margin-top:110px;margin-right: -20%;" class="banner_title_cover"><font style="color:#00a3b4; font-size:42px; font-family: 'Helvetica IE', Arial; line-height:1.1;" class="banner_title"><br />
          Organising a funeral has<br/>never been so easy</font><br />
         <!-- <font style="color:#FFFFFF; font-size:30px; fontfont-family: 'Helvetica Medium 65', Arial;">Do it yourself and organise your funeral online with family and friends.</font><br />-->
         </div>
      </div>
    </div>
  </div>
...
<div class="content_fullwidth" style="background:#00a3b4 url(../images/sliderarrow.png) center bottom no-repeat;color:#FFFFFF; ">
  <center>
    <font style="font-size:28px; font-family:Arial, Helvetica, sans-serif;" class="blue_heading">HERE'S HOW IT WORKS</font>
  </center>
  <br />
</div>
...
<div class="content_fullwidth">
  <center>
    <p style="font-family:'Helvetica Medium 65', Arial; font-size:20px;">eziFunerals is designed for people who need to organise a funeral but don't know what to do or where to start.</p>
  </center>
  </br>
  </br>
</div>
...
<!--------------------------------------------------------------------End Direct More Info popup-------------------------------------------------------------------------------->		
 ...
 <!--------------------------------------------------------------------Advance More Info popup----------------------------------------------------------------------------------->					
				...
				<div class="row">
						...
						<div class="col-md-5">
							<p>EziFunerals Advance is suitable for people who would you like<br/> to plan their funeral in advance and have greater control and <br/>input into their own funeral arrangements before they die. With this <br/>option you can reduce the stress and burden that your family and <br/>friends will face after you have passed away. With EziFunerals Advance, <br/>you are planning your funeral while you are living and you will be required <br/>to nominate a "Funeral Guardian" to administer your funeral.</p>
      ...
      <?php
        ...
        <div class="pricing-tables-two dash_plan_box2" style="background:#008c9b !important; height:185px;margin-left:3px;">
          ...
          <div class="title dash_box1_title" style="background:#00a3b4"><br />
           <a href="<?php echo base_url;?>page/funeral_guide.php" target="_blank" style="color:#FFFFFF !important"> SPECIAL OFFERS</a></div>
...
<!----------------------------------------------------------------------Forgot Password popup------------------------------------------------------------------------------------->					
					...
					<a href="#x" class="overlay" id="span15"></a>
					<div class="popup">
				...
				<div class="row">
						...
						<div class="col-md-5">
							 "Oops...", "You Are Not Client First You Have To Sign Out Then Ofter sign Up <br/>As a Directors after Registration You can access This fetures!"
						</div>
