...
<title>eziFunerals | Employer Benefits</title>
...
<?php
	...
	$pagesql = "SELECT * FROM pages WHERE id = '27'";
...
<div class="container_full">
	...
	<div class="slider_static_image_inner_emp">
...
<h2 style="color:#00a3b4;">Employers </h2>
...
<div class="grey_bg" align="" style="background:#f5f5f5; ">
	<div class="container" >
        <center><div class="one_full">
			...
			<p style="font-family:Arial, Helvetica, sans-serif; font-size:17px;">Let us know your email address and we will send you a copy of our guide for employer benefit providers.</p><br />
