...
if(isset($_POST['SaveForm']))
{
	...
	include "IntrestEmailFormate.php";
	include 'thankmessagetoclient.php';
                ...
                <div class="login_wrapper">
                	<div class="verify_box">
                        ...
                        <div class="verify_box_right">
                         <span class="verify_subtitle" style="line-height:1.5;font-family: Arial, Helvetica, sans-serif !important;">Thanks for contacting eziFunerals.<br/>
                         We will reply to your message as soon as possible.</span>
