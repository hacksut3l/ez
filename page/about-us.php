...
<title>eziFunerals | About Us</title>
...
<?php
	...
	$pagesql = "SELECT * FROM pages WHERE id = '1'";
...
<div class="mar_top5"></div>
	...
	<h3>Board of Directors</h3>
			...
			<div class="one_third last one_third_static">
				...
				<img src="../images/Funeral-Guide.jpg"><br /><br />
				<p><b style="font-size:20px; color:rgb(0, 153, 153)">Purchase a Copy Online!</b></br></br>

				
				<a href="http://www.amazon.com/What-Kind-Funeral-self-help-meaningful/dp/1925086291/ref=tmm_pap_title_0"><img src="../images/amazon.png"></a><br /><br />
