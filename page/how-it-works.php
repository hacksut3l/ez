...
<title>eziFunerals | How it works | Funeral Clients</title>
...
ul.tabs{
			margin: 443px 473px 473px 178px;
padding: 0px;
list-style: none;
position: absolute;
		}
...
<div class="tab">
	<ul class="tabs">
	<?php if(isset($_GET['type'])=='director'){
	
		?>
		
		<li class="tab-link    banner_client_link  director_link1" data-tab="tab-1">Funeral Client</li>
		<li class="tab-link current banner_director_link  director_link2" data-tab="tab-2">Funeral Director</li>	
			
	<?php		
			}else
			{	
	?>
		<li class="tab-link current   banner_client_link  director_link1" data-tab="tab-1">Funeral Client</li>
		<li class="tab-link  banner_director_link  director_link2" data-tab="tab-2">Funeral Director</li>	
