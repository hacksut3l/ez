...
<title>eziFunerals | Funeral Directors</title>
...
<?php
	...
	$pagesql = "SELECT * FROM pages WHERE id = '28'";
...
<div class="punch_text_02 blue_container">
    <div class="container">
	<br><br>
	<div align="left">
...
<div class="container_full">
	...
	<div class="slider_static_image_inner">
...
<h2 style="color:#00a3b4;">Funeral Homes</h2>
	<div style="margin-top:10px;"><p style="font-size:16px; font-family:Arial, Helvetica, sans-serif; "><?php echo $pages['description']; ?></p><br /><br />
		 ...
		 <div class="container">
			 ...
			 <div class="one_full" style="width:96%;">
				<font style="font-size:18px">
						...
						<font style="font-family: 'Helvetica Light Condensed 47',Arial; font-size:24px; font-weight:bold" class="blue_lines_1">Are you a funeral business? Need to grow your business online?
						</font> <a href="how-it-works" class="readmore_but_03 yellow_contactus yellow_contactus_funeral_home" style="margin-left:0px;">Learn More</a>
				</font>
			</div>
...
<div class="grey_bg" align="" style="background:#f5f5f5; ">
	<div class="container" >
        <center><div class="one_full">
			...
			<p style="font-family:Arial, Helvetica, sans-serif; font-size:17px;">Let us know your email address and we will send you a copy of our guide for funeral homes.</p><br />
