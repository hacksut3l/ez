      ...
      <!--start content-wrap-->
        ...
        <!--section one start here-->	
      	...
      	<div class="left-content" >
        	...
        	<h2 class="heading" style="width: 949px; background:#dcdcdc; float: left; padding-bottom: 8px; " id="div1">Person Making Arrangements </h2>
            ...
            <div class="help-f" style="width: 150px; background:#dcdcdc; float: right; padding-top:0px; margin-top:-56px;"><a href="#" class="big-link" data-reveal-id="myModal">
                   ...
                   <input type="button" class="login_button" value="preview" style="width:80px; height:25px; padding:0px; border-radius:6px; font-size:12px;"/>
                    ...
                    <div id="myModal" class="reveal-modal" style="top: -200px !important;">

                        <?php include("atneed/person-making-arrangements-edit-dashboard.php") ?>
