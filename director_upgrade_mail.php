<?php  include "MailConfig.php"; 
	...
	$to       = $email;
	$subject  = "Update plan Information";
  ...
  <tr>
    ...
    <td width="80%" style="background:#fff;">
    	<table width="100%" border="0" cellpadding="10">
          ...
          <tr>
            <td colspan="4" style="font:14px/20px Arial, Helvetica, sans-serif; color:#666;"><span style="color:#009aad; font-size:20px; font-weight:bold;">Welcome to eziFunerals!</span><br/><br/>
		your plan is Updated		
          ...
          <tr>
            ...
            <b>The eziFunerals Team</b><br /><a href="<?php echo base_url ?>" target="_blank" style="color:#009aad;">www.ezifunerals.com.au</a>
            </td>
          </tr>
       <tr>            
