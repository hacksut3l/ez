...
<div class="grey_bg" align="center" style="background:#f4f4f4; height:35px; margin-top:-40px;">
  <div class="center"><img src="images/header_AD.png" width="600" class="top_ad_top"></div>
</div>
        ...
        <table>
          <tbody>
            <tr>
			  ...
			  <div style="margin-top: -15px;" class="ezi_logo"> 
...
<a href="organise_funerals.php"><font style="padding-left:30px;" class="menu_fonts">Organise a Funeral</font></a> 

<a href="findfuneral_director.php"><font style="padding-left:20px;" class="menu_fonts">Find a Funeral Director</font></a> 

<a href="pages/HowItWorks.php"><font style="padding-left:17px;" class="menu_fonts">How it Works</font></a> 
...
include_once('config.php');
 @session_start();
			...
			?>
				...
				<a href="signin.php"  style="margin-left:5px; border-radius:50px; padding:10px 30px;" class="login_button">SIGNUP</a> 
				&nbsp;&nbsp;&nbsp; 
				
				<a href="signin.php"  style="margin-left:-10px;border-radius:50px; padding:9px 30px;" class="readmore_but_03" >LOGIN</a>
                ...
                <nav id="primary_nav_wrap">
                  <ul>
                    ...
                    <?php
							...
							{	
					?>
								<li><a href="client_dashboard.php">My Dashboard&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/arrow.png" /></a>
					<?php
					}
					else
					{
					?>
								<li><a href="director_dashboard.php">My Dashboard&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/arrow.png" /></a>
					<?php }
