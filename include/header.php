...
<div class="grey_bg" align="center" style="background:#f4f4f4; height:35px; margin-top:-40px;">
        ...
        <div class="center"><a href="how-it-works?type=director"><img src="../images/header_AD.png" width="600" class="top_ad_top"></a></div>
 ...
 @session_start();
			...
			?> 
             <div style=" margin-top:12px;" class="login_signup">
                <a href="how-it-works"  style="margin-left:5px; border-radius:50px; padding:10px 30px;font-size:14px" class="login_button">SIGNUP</a>
			
				
				   &nbsp;&nbsp;&nbsp;  <a href="../signin.php"  style="margin-left:-10px;border-radius:50px; padding:9px 30px;font-size:14px" class="readmore_but_03" >LOGIN</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  </div>
            <?php
				}
				 else
...
<nav class="nav">
	<ul>
		...
		<li><a href="./how-it-works"><font>How it Works</font></a> </li>
