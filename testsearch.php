...
//										location.reload();
                ...
                function loadData(page){
                    ...
                    ({
                        type: "POST",
                        url: "funeral_director_test_search.php",
...
<div class="gridContainer clearfix">
  <div id="LayoutDiv1">
      <div id="wrapper">
       		<div id="container">
              <?php include("include/listing_header.php"); ?><br/><br/><br/><br/><br/><br/><br/><br/><br/>
              
     <div style="background:none;  width: 100%; float:left">
            	<div class="header-gradient">
                   <div class="find_ex">
               			<form method="get" action="funeral_directors.php" id="main_search">
                ...
                <div class="in-content">
                       <span class="fun-text">Select a Funeral Director in your area</span>
                       <div id="map" style="width: 23%; height: 243px;margin-bottom: 30px;float:left; margin-right:20px;"></div>
				  ...
				  <!-- <div class="google">
				   ...
				   <div style="width:60%; float:left;" id="container1">  
...
?>
	...
	//alert(locations[i][1]+","+locations[i][2]); 
      ...
      google.maps.event.addListener(marker, 'click', (function(marker, i) {
       ...
       <div id="notlogin" style="display:none">
						<div id="">    
					<span class="reg_name businessPopSpan">Please login to add a review for this Funeral Director</span>
					
                    <span style="width:100%; float:left; text-align:center;">
                        <!--<span class="reg_name">&nbsp;</span>-->
                        <span style="">
                        <a style="float:inherit;padding: 5px 8px;" href="<?php echo base_url;?>login.php?country=<?php echo $_REQUEST['country'];?>&state=<?php echo $state_name['state_name'];?>&city=<?php echo $_REQUEST['city'];?>" class="signup_btn">Login</a>
                        </span>
                    </span>
    ...
    <div id="notlogin2" style="display:none">
						<div id="">    
					<span class="reg_name businessPopSpan">Please login to invite this Funeral Director to quote on your funeral</span>
