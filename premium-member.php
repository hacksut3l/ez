...
<title>eziFunerals | PremiumMember </title>
  ...
  <div id="LayoutDiv1">
      <div id="wrapper">
       		<div id="container"><br/><br/><br/><br/><br/><br/>
                ...
                <!----	<img src="images/Plan-Your-Funeral-Banner.jpg" />	--->
                </div>
                <div class="in-content">
                   ...
                   <div class="user_box inner_member">
                    ...
                    <div class="user_info">
                    	<p class="right-text company_name_m"><strong><?php echo ucwords($result['business_name']);?></strong>&nbsp;<img src="images/premium1.png" style="  vertical-align: middle;" class="premium_image"></p>
                        <p>
<?php echo ucwords(str_replace(","," ",$result['address'])).' '.ucwords($cities).'  '.ucwords($states).' '.ucwords($postal_code);?>
<?php echo  " ".ucwords($result['country']);?></p>
                        <p class="user_contact"><?php $result['phone'];?></p>
      <?php     
	  	...
	  	$invit_sql = "SELECT 
			...
			$invite_present = @mysql_num_rows($invite_sql_ex);
				...
				else
				{
					...
					{
						$invite = '<a href="#pop12_'.$directors['id'].'" director_id="'.$directors['id'].'" class="invite inner_invite" style="height:17px !important; width:105px !important">Request a Quote</a>';
					} 
                   ...
                   <div class="tabpanel_box">
                     <div id="TabbedPanels1" class="TabbedPanels inner_tab">
                       ...
                       <div class="TabbedPanelsContentGroup">
                         ...
                         <div class="TabbedPanelsContent">
                         	<?php
								$photosql = "SELECT * FROM photo_gallery WHERE director_id = '".$did."' ";
							...
							echo '<ul id="fade" style="width:100%;">';
									...
									{
										$imgname1 = base_url."uploads/photo_gallery/".$did."/".$photo['image'];
							?>
                            <!-- <li style="float: left;width: 275px;height: 270px; margin: 6px; list-style: none;">
                                 <a class="fancybox fancybox.iframe" href="<?php echo base_url;?>uploads/photo_gallery/<?php echo $did;?>/<?php echo $photo['image'];?> " style="height:100%; width:100%;"><img src="<?php echo base_url;?>uploads/photo_gallery/<?php echo $did;?>/<?php echo $photo['image'];?>" style="float: left;width:100%!important; height:100%;"/></a></li>-->
								  <li style="float: left;width: 275px;height: 250px; margin: 6px; list-style: none;">
								 <a href="#x" class="overlay" id="<?php echo $photo['id'];?>"></a>
					
												<div class="popup">
										<img src="<?php echo base_url;?>uploads/photo_gallery/<?php echo $did;?>/<?php echo $photo['image'];?>" style="float: left;width:100%!important; height:100%;"/>
									
					
										<a class="close" href="#close"></a>
									</div>
								
                               <a id="login_pop" class="btn btn-primary" href="#user_forgot">  <a href="#<?php echo $photo['id'];?>"><img src="<?php echo base_url;?>uploads/photo_gallery/<?php echo $did;?>/<?php echo $photo['image'];?>"  style="float: left;width:100%!important; height:100%; max-width:270px; max-height:200px;"/></a></li>
                          <?php
									}
								echo '</ul>';
//echo'</div>';
                         ...
                         <div class="TabbedPanelsContent">
                         	<?php
							$videosql = "SELECT * FROM video_gallery WHERE director_id = '".$did."' ORDER BY id";
							...
							?>
                         		<div class="tab_photogallery">
									<a class="video fancybox fancybox.iframe"  title='Video' href='http://www.youtube.com/v/<?php echo $video['url'];?>?fs=1&amp;autoplay=1' style='padding:6px;'><img src='http://img.youtube.com/vi/<?php echo $video['url'];?>/default.jpg' style="width:292px;" alt='' /></a>
                         ...
                         <div class="TabbedPanelsContent">
							...
							?>
                            	<div class="reiew_box">
                                	<div class="review_photo"><img src="<?php echo base_url;?>uploads/clients_profile_pics/<?php echo $rating['image'];?>" width="120px" height="130px"/></div>
                                    <div class="review_text">
                                    	<p class="review_name"><?php echo ucwords($rating['first_name']).' '.ucwords($rating['last_name']);?></p>
                                        <p><div class="exemple4" data-average="<?php echo $rating['rate_recorded'];?>" data-id="<?php echo $rating['rate_to'];?>"></div></p>
                                        <hr />
...
<!--<div id="tets<?php echo $result['id'];?>" style="display:none">
						<div id="">    
					<h1>Add Review</h1>
					<span class="fields_wrapp no_margin">
											<span class="reg_name">Rating</span>
											<div class="rating" style="margin-left:0;">
												<div class="exemple7" data-average="<?php echo $result['rating'];?>" data-id="<?php echo $result['id'];?>" average="<?php echo $result['rating'];?>" director_id ="<?php echo $result['id'];?>"></div>
											</div>
										</span>
					<span class="fields_wrapp no_margin">
										...
										<span class="fields_wrapp no_margin">
											<span class="reg_name">Review</span>
											<textarea class="reg_field_<?php echo $result['id'];?>'" style="height:60px;" director_id ="<?php echo $result['id'];?>" name="reviewtext" id="sammeer_<?php echo $result['id'];?>"></textarea>
											
										</span>
										<span style="width:100%; float:left;">
											<span class="reg_name">&nbsp;</span>
											<input class="signup_btn ratingpopup rakesh123" type="button" client_id = "<?php echo $_SESSION['client'];?>" director_id ="<?php echo $result['id'];?>"  name="submit" value="Submit">
										</span>
