                ...
                <div class="fields"  style="display:none;">
                  ...
                  <select id="ddlTransactionType" name="ddlTransactionType" style="width:140px;">
                   <option value="Recurring">Recurring</option>
									...
									<div class="reg_box">
										<span class="login_head director_heading" style="font-size:32px;">Basic Membership Application <span class="step">Step 2 of 2</span></span>
										<p> Below one time establishment fee will immediately be charged to your credit card, to confirm your membership as a Basic Member. When eziFunerals provides you with a pre-qualified lead (which includes the individual’s full name, email address, phone number, and funeral details) an additional $99 per lead is what you agree to be charged per lead provided, tallied at the end of each calendar month for all leads provided.
				</p>
								<?php
									//echo $dir = dirname(__FILE__);exit;
									//require_once($dir.'atneed/swift/swift_required.php');
									...
									if(isset($_POST['submit']))
									{
										...
										if(isset($_SESSION['person_id']))
										{
											...
											$up_plan="update directors set user_type='1' where id='".$_SESSION['person_id']."'";
								...
								?>
										...
										<div class="verify_box">
                       					 ...
                       					 <div class="verify_box_right">
												 ...
												 Next step: verify your email address.</b>
											  </span>
								...
								?>
									 <span class="fields_wrapp marginTop tablr_bor">
												<table width="100%" border="0">
													...
													<tr>
														<td class="reg_table_text">Establishment Fee</td>
														<td class="reg_table_text">$1.00</td>
													</tr>
													
													<tr>
														<td class="reg_table_text"><strong>Total Due Today</strong></td>
														<td class="reg_table_text"><strong>$1.00</strong></td>
													</tr>
												</table>
											</span>
									  <div class="left_reg_form_next">
										<!--<span class="fields_wrapp marginTop">
											<p class="reg_box_p_next">Purchase Summary:</p>
											<span class="reg_name ename">$0.00 Recurring Fee (every 1 month)</span>
										</span>-->
										<span class="fields_wrapp marginTop">
											<!--<p class="reg_box_p_next">Today's Total: $0.00</p>
											<span class="reg_name ename">(then $0.00 at first renewal on 05/26/2013)</span>-->
											<label class="login_checkbox" style="margin-top:-3px;"><input class="check" id="terms" type="checkbox">I accept the <a href="<?php echo base_url;?>page/terms-of-use" target="_blank">Terms and Conditions</a></label>
										</span>
