...
/*if($_SESSION['client']!='' || $_SESSION['person_id']!='')
{
	header('Location:free-membership-registration-next.php');
}	*/
...
<div class="punch_text_02 funral_director_heading">
    <div class="container">
	<div align="left">
        	<font style="font-family: 'Helvetica IE',Arial; font-size:24px;">Funeral Director Basic  Membership Plan</font>	
    </div>
	</div>
</div>
...
<div class="gridContainer clearfix">
  <div id="LayoutDiv1"><br/><br/>
			
<div id="container"><div id="wrapper">
        
 				<div class="container">         
                	
                    <h2 class="heading director_heading" style="font-size:24px;">Basic Membership Application<span class="step"> Step 1 of 2</span></h2>
...
//                        if($_POST['area_location'] == '')
//                        {
//                            //echo 'hi';exit;
//                                $arealocerror = 'Please enter business location';
//                        }
                      if($flag==0)
                        {
                                //echo 'hi';exit;
                                ...
                                $citi_free =    $city_name_dis['city_id']; 
...
//                        }
        ...
        ?>
					...
					<form action="" method="POST" id="basic_reg_form">
                      ...
                      <fieldset class="fieldset director_fieldset"><!--<legend class="legend">Contact Information</legend>-->
                        ...
                        <span class="fields_wrapp1">
                        	...
                        	<input class="reg_field" type="text" name="email" id="email" value="<?php if(isset($_POST['email'])) echo $_POST['email'];?><?php if($isresult > 0 && !isset($_POST['email'])) echo $result['email'];else if(isset($_SESSION['person_id'])) echo $row_director_info['email'];?>"<?php if(isset($_SESSION['person_id'])){?>readonly=""<?php }  ?>onBlur="emailrepeatcheck(this.value)">
                        ...
                        <span class="fields_wrapp1">
                        	...
                        	<input class="reg_field" type="text" name="phone" id="phone" value="<?php if(isset($_POST['phone'])) echo $_POST['phone']; else if(isset($_SESSION['person_id'])) echo $row_director_info['phone'];?><?php if($isresult > 0 && !isset($_POST['phone'])) echo $result['phone'];?>" maxlength="10">
                        ...
                        <span class="fields_wrapp1">
                        	...
                        	<input class="reg_field" type="text" name="business_name" id="business_name" value="<?php if(isset($_POST['business_name'])) echo $_POST['business_name']; else if(isset($_SESSION['person_id'])) echo $row_director_info['business_name'];?><?php if($isresult > 0 && !isset($_POST['business_name'])) echo $result['business_name'];?>">
                      ...
                      <fieldset class="fieldset director_fieldset" style="margin-bottom:10px;"><!--<legend class="legend">Company Information</legend>-->
                        <span class="fields_wrapp">
                            ...
                            <select class="defaultSelect" name="country" id="country">
                                ...
                                <option value="Australia" <?php if(isset($_POST['country']) && $_POST['country'] == 'Australia') echo 'selected=selected';?><?php if($isresult > 0 && !isset($_POST['country']) && $result['country'] == 'Australia') echo 'selected=selected';?>>Australia</option>
                            </select>
							-->
                        ...
                        <span class="fields_wrapp1">
                            ...
                            <span class="reg_name ename">Select State <span class="red">*</span></span>
                            <select class="defaultSelect" name="state" id="state">
                                ...
                                <?php
									...
									while($states = mysql_fetch_assoc($statesex))
									{
										...
										else if(!isset($_POST['state']) && $isresult > 0 && $result['state'] == $states['state_id'])
										{
											$selected = 'selected=selected';
										}
										else
                            ...
                            <span class="formerror" style="float: left;width: 200px;color: red;font-family: 'open_sansregular'; font-size: 13px;"><?php if(isset($stateerror)) echo $stateerror;?></span>
                        ...
                        <span class="fields_wrapp1">
                        	<span class="reg_name ename">Select Suburb <span class="red">*</span></span>
                            <span id="city_span">
                            ...
                            <input class="reg_field" type="text" name="city" id="city" value="<?php if(isset($_POST['city'])) echo $_POST['city'];else if(isset($_SESSION['person_id'])) echo $city_name25['city_name'];?>" style="margin-left:0px !important;">             
                            </span>   
                            <span class="formerror" style="float: left;width: 200px;color: red;font-family: 'open_sansregular'; font-size: 13px;"><?php if(isset($cityerror)) echo $cityerror;?></span> 
                            <span class="formerror1" id="suburberror">Please Select Suburb.</span>     
                        </span>
                        
                        
                        <span class="fields_wrapp1">
                        	<span class="reg_name ename">Postal Code / Zip <span class="red">*</span></span>
                        	<input class="reg_field" type="text" name="postal_code" id="postal_code" value="<?php if(isset($_POST['postal_code'])) echo $_POST['postal_code'];else if(isset($_SESSION['person_id'])) echo $row_director_info['postal_code'];?><?php if($isresult > 0 && !isset($_POST['postal_code'])) echo $result['postal_code'];?>" maxlength="4">
                        ...
                        <span class="fields_wrapp1">
                        	...
                        	<textarea class="reg_tarea" name="address" id="address"><?php if(isset($_POST['address'])) echo $_POST['address'];else if(isset($_SESSION['person_id'])) echo $row_director_info['address'];?><?php if($isresult > 0 && !isset($_POST['address'])) echo $result['address'];?></textarea>
