...
If you have any questions, please email us at <a href="mailto:peter@ezifunerals.com.au">peter@ezifunerals.com.au</a>
                      ...
                      <div class="left_reg_form_next">
                        <span class="fields_wrapp marginTop">
                        	<span class="reg_name ename">Below fee will be immediately charged to your credit card, and will be charged each subsequent month that you continue your membership as a Premium Member. </span>
                        </span>
                        ...
                        <span class="fields_wrapp marginTop tablr_bor">
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td class="reg_table_text">$199.00</td>
                                </tr>
                                
                                <tr>
                                	<td class="reg_table_text">Total Locations</td>
                                    <?php 
										$locamount = $_COOKIE["total_location"] * 10;
										
										$final_amount = $locamount + 199;
									?>
                                    <td class="reg_table_text"><?php echo $_COOKIE["total_location"];?> * $10 = <?php echo $locamount;?></td>
                                </tr>
                      ...
                      <form name="person_making_form" action="payment_action.php" method="POST">
                        ...
                        <input type="hidden" name="vpc_OrderInfo" value="Standard Member"/>
                        <input type="hidden" name="vpc_Amount" value="<?php echo $final_amount;?>00"/>
                        <input type="hidden" name="vpc_ReturnURL" value="<?php echo base_url;?>manual_premium_response.php" />
                        <input type="hidden" name="vpc_Locale" value="en" />
                        
                        
                        <span style="width:100%; float:left;">
                        	<a href="#"><input class="invite_director_btn" type="submit" value="Place My Order"></a>
                        </span>
                       </form> 
