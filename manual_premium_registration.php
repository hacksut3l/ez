            ...
            <div style="width:100%; float:left; padding-bottom:20px;">
                ...
                <div class="login_wrapper">
                	<div class="reg_box">
                        ...
                        <span class="forms_tag_line">$199.00 per Month</span>
                        <p>Thank you for your interest in our Exclusive Premium Membership Package. By joining as a member, you will get priority listing, premium leads and be able to list a special offers or promotions, which we'll feature in individual funeral business profiles. Simply fill in your information below and accept our terms and conditions.			
</p>
                    ...
                    if(isset($_POST['submit']))
                    {
						...
						$sql = "UPDATE
								...
								SET
									...
									city = '".$_POST['business_city1']."',
									state = '".$_POST['business_state1']."',
						...
						header('Location:manual_premium_next.php');
                    }
                ?>
                ...
                <form action="" method="POST" id="premium_reg_form">
                      ...
                      <p class="reg_box_p">Contact Information</p>
                        ...
                        <!--<span class="fields_wrapp1 addPreField">
                        	...
                        	<input class="reg_field" type="text" name="city" id="city">
                        </span>
                        
                        <span class="fields_wrapp1 addPreField">
                        	<span class="reg_name ename">State <span class="red">*</span></span>
                        	<input class="reg_field" type="text" name="state" id="state">
                        </span>-->
			...
			<select class="defaultSelect" >
                ...
                <option value="Option 5">England</option>
                        ...
                        <span class="fields_wrapp1">
                        	...
                        	<input class="reg_field" type="text" name="postal_code" id="postal_code">
                        </span>
                        
                        
                        <span class="fields_wrapp1">
                        	<span class="reg_name ename">Address</span>
                        	<textarea class="reg_tarea" name="address" id="address"></textarea>
                        </span>-->
                      </div>
                      <div class="left_reg_form addPremium" style="float:right;">
                        ...
                        <span class="add_loc span_no1">
                            <span class="fields_wrapp1 addSmallFields">
                                <span class="reg_name ename">City<span class="red">*</span></span>
                                <input class="reg_field preInput" type="text" name="business_city1" id="business_city1" value="<?php echo $result['city'];?>">
                            </span>
                            <span class="fields_wrapp1 addSmallFields">
                                <span class="reg_name ename">State<span class="red">*</span></span>
                                <input class="reg_field preInput" type="text" name="business_state1" id="business_state1"  value="<?php echo $result['state'];?>">
                            </span>
                            <span class="fields_wrapp1 addSmallFields">
                                ...
                                <!--<input class="reg_field preInput" type="text" name="business_country1" id="business_country1">-->
                            </span>
                            <span class="fields_wrapp1 addSmallFields">
                                <span class="reg_name ename">Address<span class="red">*</span></span>
                                <input class="reg_field preInput" type="text" name="business_address1" id="business_address1" value="<?php echo $result['address'];?>">
                            </span>
                            <span class="fields_wrapp1 addSmallFields">
                                <span class="reg_name ename">Zip Code<span class="red">*</span></span>
                                <input class="reg_field preInput" type="text" name="business_zip1" id="business_zip1"  value="<?php echo $result['postal_code'];?>">
                            </span>
