<?php
	...
	echo	$sql = "SELECT * FROM invite where invite_from='".$_GET['id']."'";
...
<!--<div class="btn-toolbar">
  ...
  <h1 style="color:#000000;" ><center>Request View Quotes</center></h1>
<div class="well">
    ...
    <table class="table">
      ...
      <?php
		...
		$sql1 = "SELECT * FROM directors where id='".$data['invite_to']."'";
