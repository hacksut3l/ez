<?php
	...
	if(isset($_SESSION['admin_username']))
	{
		...
		$sql = "SELECT * FROM directors WHERE manual_entry = '1' AND state='".$_GET['state']."' OR city='".$data['city_id']."'  ORDER BY id DESC";
		
		}else
		{
		
			$sql = "SELECT * FROM directors WHERE manual_entry = '1' ORDER BY id DESC";
...
<div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Pre-Populated Members</h1>
        </div>
