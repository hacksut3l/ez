<?php
	...
	if(isset($_SESSION['admin_username']))
	{
		...
		$sql = "SELECT * FROM directors WHERE user_type = '3' AND manual_entry != 1 AND state='".$_GET['state']."' AND city='".$data['city_id']."'  ORDER BY id DESC";
		
		}
		else
		{
			$sql = "SELECT * FROM directors WHERE user_type = '3' ORDER BY id DESC";
...
<div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Premium Members</h1>
        </div>
        
                <ul class="breadcrumb">
            <li><a href="">Members</a> <span class="divider">/</span></li>
            <li class="active">Manage Premium Members</li>
        </ul>
