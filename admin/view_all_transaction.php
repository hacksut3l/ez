<?php
	...
	if(isset($_SESSION['admin_username']))
	{
		...
		$sql = "SELECT * FROM client_purchase_info ORDER BY id DESC ";
    ...
    <table class="table" border="0">
	  ...
	  ?>
            <tr>
              ...
              <td>
              	<?php 
						$namesql="select * from clients where id=".$data['client_id']."";
              ...
              <td>
               ...
               <td>
                 <a target="_blank" href="view_transaction.php?tid=<?php echo $data['id'];?>">View</a>
              </td>
