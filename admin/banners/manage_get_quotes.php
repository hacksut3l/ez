<?php
	...
	if(isset($_SESSION['admin_username']))
	{
		...
		$sql = "SELECT * FROM banners WHERE page_name = 'Get Quotes' ORDER BY id DESC";
...
<a href="<?php echo base_url;?>admin/banners/add_get_quotes.php" class="btn btn-primary">ADD</a>
<div class="well">
    <table class="table">
      <thead>
        <tr>
	  ...
	  ?>
            <tr>
              ...
              <td><img src="<?php echo base_url;?>admin/uploads/get_quotes/<?php echo $data['image_name'];?>" style="width: 253px;height: 94px;"></td>
              <td>
                  <a href="<?php echo base_url;?>admin/banners/edit_get_quotes.php?id=<?php echo $data['id'];?>"><i class="icon-pencil"></i></a>
