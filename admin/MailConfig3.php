...
function email($name,$mail,$message,$subject,$pdf,$customer){
 ...
 $from_name = "eziFunerals";
 $from = "sam@ezifunerals.com.au";
...
$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
 ...
 /*$mail->AddAttachment('invoice/ex/allinvoice/'.$file.'');*/
$mail->AddAttachment('allinvoice/'.$file.''); 
 
  //$mail->AddEmbeddedImage('images\true.gif', 'logoimg1','true.gif','base64', 'image/gif');
 $mail->IsSMTP();
 $mail->Host     = "smtp.ezifunerals.com.au";
 $mail->Port     = 25;
 $mail->SMTPAuth = true;
 $mail->Username = "sam@ezifunerals.com.au";
...
<address style="text-align: center;"> </address>
 ...
 function eemail($name,$mail,$message,$subject,$customer){
 // Include the PHPMailer classes
 // If these are located somewhere else, simply change the path.
 require_once("PHPMailer/class.phpmailer.php");
 require_once("PHPMailer/class.smtp.php");
...
$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
 ...
 // Can use SMTP
 // comment out this section and it will use PHP mail() instead
 $email->AddEmbeddedImage('images\bhavna_favicon.ico', 'logoimg','Bhavna Gum Udhyog','base64', 'image/ico');
 $email->AddEmbeddedImage('images\aspire.ico', 'logoimg1','Aspire Web Service','base64', 'image/ico');
 
 
  //$mail->AddEmbeddedImage('images\true.gif', 'logoimg1','true.gif','base64', 'image/gif');
 $email->IsSMTP();
 $email->Host     = "mail.greencubes.co.in";
 $email->Port     = 25;
 $email->SMTPAuth = true;
 $email->Username = "miraj@greencubes.co.in";
 $email->Password = "Green123/*-";
 $email->IsHTML(true);
 if($customer=="Yes" or $customer=="Y"){
  $message=  '<html>
  <style type="text/css">
