...
<div class="punch_text_02">
    <div class="container">
	<div align="center">
        	<font style="font-family: 'Helvetica IE',Arial; font-size:24px;">Standard Membership Registration</font>	
    </div>
	</div>
</div>
			    ...
			    <div class="login_wrapper">
                	<div class="verify_box">
                        ...
                        <div class="verify_box_right">
							...
							{
							?>
                        	<span class="verify_subtitle"><b>Account created!</b></span>
                            <span class="verify_subtitle">Please click on the link sent to <span><?php echo $_SESSION["free_email"];?></span> to complete your profile.</span>
