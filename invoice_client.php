<?php 
 ...
 if($row_of_plan['plan'] == '2') { $plan = "Direct"; } else { $plan = "Advance"; } 
	$to       = $email;
...
'.$row_of_plan['first_name'].'<br/>
'.$row_of_plan['last_name'].'<br/>
'.$row_of_plan['address'].'<br/>
'.$row_of_city['city_name'].$row_of_plan['zip_code'].'<br/>
'.$row_of_plan['country'].'<br/>
'.$row_of_plan['phone'].'<br/></div>
</div>
...
border-left: 1px solid #f1f1f1;">eziFunerals&nbsp;'.$plan.'&nbsp;Plan<br/></td>
