...
<title>eziFunerals | FreeMembers</title>
       		...
       		<div id="container" >
                ...
                <div class="in-content">
                   ...
                   <div class="user_box inner_member">
                    ...
                    <img src="<?php echo base_url;?>uploads/director_profile_pics/<?php echo $result['image'];?>" style="width:120px; height:auto" class="profile_image"/>
                    	<!--<img src="images/user_logo.png"/>-->
						<?php
							if($result['manual_entry'] == '1' && !isset($_SESSION['client']))
							{
						?>
                        <!--<div class="pre_btns">
                    		<a href="#tets" class="pre_btn1 fancybox1">Is This Your Business?</a>
                        	<!--<a href="#" class="pre_btn2">Add Review</a>
                    	</div>-->
						<?php
							}
							else
	...
	$pdfex = mysql_query($pdfsql);
	 ...
	 $is_pdf_present = @mysql_num_rows($pdfex);
	  	$invit_sql = "SELECT 
			...
			$invite_present = @mysql_num_rows($invite_sql_ex);
				...
				else
				{
					...
					{
						$invite = '<a href="#pop12_'.$directors['id'].'" class="invite inner_invite" style="width:105px !important;height:17px !important;"  director_id="'.$directors['id'].'">Request a Quote</a>';
					} 
					else if($is_pdf_present > 0 && isset($_SESSION['client']) && $invite_present > 0)
					{
				
						$invite = '<a href="#send_'.$directors['id'].'" class="invite inner_invite" style="width:105px !important;height:17px !important;"  director_id="'.$directors['id'].'">Request a Quote</a>';
					}
				 
				
					if($is_pdf_present <= 0 && isset($_SESSION['client']))
					{
						$invite = '<a href="post-your-plan.php?id='.$directors['id'].'" class="invite inner_invite" style="width: 120px;padding: 8px">Request a Quote</a>';
					}
					if(!isset($_SESSION['client']))
					{
		...
		?>			 
					...
					<div id="loading"></div>
                    <div id="map" class="inner_map" style="width: 250px; height: 150px;margin-bottom: 30px;float:left;"></div>
                    <!--<div class="user_map">
						...
						?>				
								<!-- <li style="float: left;width: 275px;height: 270px; margin: 6px; list-style: none;">
								 ...
								 <a href="#x" class="overlay" id="<?php echo $photo['id'];?>"></a>
												...
												<div class="popup">
										<img src="<?php echo base_url;?>uploads/photo_gallery/<?php echo $_GET['id'];?>/<?php echo $photo['image'];?>" style="float: left;width:100%!important; height:100%; max-width:270px; max-height:200px;"/>
	...
	echo '</ul>';
                         ...
                         <?php
							...
							?>
                                ...
                                <a class='video fancybox fancybox.iframe'  title='Video' href='http://www.youtube.com/v/<?php echo $video['url'];?>?fs=1&amp;autoplay=1' style='padding:6px;'><img src='http://img.youtube.com/vi/<?php echo $video['url'];?>/2.jpg' style="width: 292px;" alt='' /></a>
							...
							?>
                            	<div class="reiew_box">
                                    ...
                                    <div class="review_text">
                                        ...
                                        <p><div class="exemple4" data-average="<?php echo $rating['rating'];?>" data-id="<?php echo $rating['rate_to'];?>"></div></p>
                                        <hr />
...
<div id="tets" style="display:none">
    <div id="">    
        <!--<h1>Add Review</h1>-->
        <span class="fields_wrapp no_margin">
            <span class="reg_name businessPopSpan">Welcome to EziFunerals.<br />
Your complimentary listing is provided for a limited time only.
            ...
            <span class="reg_name businessPopSpan"><a href="<?php echo base_url;?>manual_director_membership.php?id=<?php echo $result['id']?>"><input style="float:inherit;" class="invite_director_btn" type="button" value="Register Now"></a></span>
        </span>
    </div>
</div>  
